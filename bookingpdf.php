  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6 my-auto">
        <div class="img_book">
          <img src="assets/images/LIGHT-WATER-LOGO.png" style="width: 100%">
        </div>
      </div>
      <div class="col-md-6 ">
        <div class="txt_hd">
          <h2>INVOICE</h2>
          <h4>Date:D-M-Y</h4>
          <h4>Invoice Number:1234567890</h4>
        </div>
      </div>
    </div>
    </div>
      ...
      <div class="col-md-12">
        <div class="usr_details">
          ...
          <ul>
            ...
            <li>          <h4>Contact Details:123456652</h4></li>
            <li>          <h4>Email Address:info@example.com</h4></li>
          </ul>
        ...
        <div class="tot">
          <div class="row">
            <div class="col-md-6">
              <div class="pay-info">
                <h3>Payment Info</h3>
                <h4>Card Number:321342243</h4>
                <h4>Card Name:John</h4>
                <h4>Any Text Here</h4>
              </div>
            </div>
            <div class="col-md-6">
